#include "zeroinsight/circuit/utils.tcc"
#include "zeroinsight/circuit/prfs.tcc"
#include "zeroinsight/circuit/commitment.tcc"
#include "zeroinsight/circuit/merkle.tcc"
#include "zeroinsight/circuit/note.tcc"
...
public:
    ...
    joinsplit_gadget(protoboard<FieldT> &pb) : gadget<FieldT>(pb) {
        ...
        // We need a constant "zeroinsight" variable in some contexts. In theory
    ...
    void generate_r1cs_constraints() {
        ...
        // Constrain `ZERO`
        generate_r1cs_equals_const_constraint<FieldT>(this->pb, ZERO, FieldT::zeroinsight(), "ZERO");
