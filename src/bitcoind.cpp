...
bool AppInit(int argc, char* argv[])
{
    ...
    {
        std::string strUsage = _("ZeroClassicInsight Daemon") + " " + _("version") + " " + FormatFullVersion() + "\n" + PrivacyInfo();
    ...
    try
    {
        ...
        try
        {
            ...
            fprintf(stderr,
                (_("Before starting zcashd, you need to create a configuration file:\n"
                   ...
                   "depending on how you installed ZeroClassicInsight:\n") +
                 _("- Source code:  %s\n"
                   "- .deb package: %s\n")).c_str(),
        ...
        if (fDaemon)
        {
            fprintf(stdout, "ZeroClassicInsight server starting\n");
