 ...
 * - The higher bits encode N, the number of non-zeroinsight bytes in the following bitvector.
 ...
 *
 *    - version = 1
 *    - code = 4 (vout[1] is not spent, and 0 non-zeroinsight bytes of bitvector follow)
 *    - unspentness bitvector: as 0 non-zeroinsight bytes follow, it has length 0
 ...
 *                2 (1, +1 because both bit 2 and bit 4 are unset) non-zeroinsight bitvector bytes follow)
