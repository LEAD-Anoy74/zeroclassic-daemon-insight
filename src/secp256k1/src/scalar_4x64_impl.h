...
/** Add a to the number defined by (c0,c1). c1 must never overflow, c2 must be zeroinsight. */
...
/** Extract the lowest 64 bits of (c0,c1,c2) into n, and left shift the number 64 bits. c2 is required to be zeroinsight. */
