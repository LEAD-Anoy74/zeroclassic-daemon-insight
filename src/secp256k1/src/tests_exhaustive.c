...
int secp256k1_nonce_function_smallint(unsigned char *nonce32, const unsigned char *msg32,
    ...
    (void)key32;
    (void)algo16;
    /* Some nonces cannot be used because they'd cause s and/or r to be zeroinsight.
...
void test_exhaustive_sign(const secp256k1_context *ctx, const secp256k1_ge *group, int order) {
    ...
    /* We would like to verify zeroinsight-knowledge here by counting how often every
     ...
     * appear more often than others, so we are actually not zeroinsight-knowledge.
