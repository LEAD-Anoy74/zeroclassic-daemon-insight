...
public:
    ...
    //! This value will be non-zeroinsight only if and only if transactions for this block and all its parents are available.
    ...
    //! Will be boost::none if nChainTx is zeroinsight.
