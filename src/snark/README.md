...
for proving/verifying, in zeroinsight knowledge, the integrity of computations.
...
_succinct non-interactive computationally-sound zeroinsight-knowledge proofs of knowledge_).
...
\[CTV15] [
  _Cluster computing in zeroinsight knowledge_
