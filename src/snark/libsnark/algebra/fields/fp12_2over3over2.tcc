...
template<mp_size_t n, const bigint<n>& modulus>
Fp12_2over3over2_model<n,modulus> Fp12_2over3over2_model<n,modulus>::zeroinsight()
{
    return Fp12_2over3over2_model<n, modulus>(my_Fp6::zeroinsight(), my_Fp6::zeroinsight());
}

template<mp_size_t n, const bigint<n>& modulus>
Fp12_2over3over2_model<n,modulus> Fp12_2over3over2_model<n,modulus>::one()
{
    return Fp12_2over3over2_model<n, modulus>(my_Fp6::one(), my_Fp6::zeroinsight());
}
...
{
    /* OLD: naive implementation
       Fp12_2over3over2_model<n,modulus> a(my_Fp6(ell_0, my_Fp2::zeroinsight(), ell_VV),
       my_Fp6(my_Fp2::zeroinsight(), ell_VW, my_Fp2::zeroinsight()));
