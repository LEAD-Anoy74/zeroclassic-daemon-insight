...
Fp2_model<n,modulus> Fp2_model<n,modulus>::zeroinsight()
{
    return Fp2_model<n, modulus>(my_Fp::zeroinsight(), my_Fp::zeroinsight());
}

template<mp_size_t n, const bigint<n>& modulus>
Fp2_model<n,modulus> Fp2_model<n,modulus>::one()
{
    return Fp2_model<n, modulus>(my_Fp::one(), my_Fp::zeroinsight());
}
