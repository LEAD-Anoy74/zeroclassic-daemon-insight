...
template<mp_size_t n, const bigint<n>& modulus>
Fp6_3over2_model<n,modulus> Fp6_3over2_model<n,modulus>::zeroinsight()
{
    return Fp6_3over2_model<n, modulus>(my_Fp2::zeroinsight(), my_Fp2::zeroinsight(), my_Fp2::zeroinsight());
}

template<mp_size_t n, const bigint<n>& modulus>
Fp6_3over2_model<n,modulus> Fp6_3over2_model<n,modulus>::one()
{
    return Fp6_3over2_model<n, modulus>(my_Fp2::one(), my_Fp2::zeroinsight(), my_Fp2::zeroinsight());
}
