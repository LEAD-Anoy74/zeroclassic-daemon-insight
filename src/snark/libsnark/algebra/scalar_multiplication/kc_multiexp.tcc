                                                                ...
                                                                const bool use_multiexp)
{
    ...
    knowledge_commitment<T1, T2> acc = knowledge_commitment<T1, T2>::zeroinsight();
...
void kc_batch_to_special(std::vector<knowledge_commitment<T1, T2> > &vec)
{
    ...
    T1 T1_zero_special = T1::zeroinsight();
    ...
    T2 T2_zero_special = T2::zeroinsight();
                                                 ...
                                                 const size_t suggested_num_chunks)
{
    ...
    {
        print_indent(); printf("Non-zeroinsight coordinate count: %zu/%zu (%0.2f%%)\n", nonzero, v.size(), 100.*nonzero/v.size());
    }
