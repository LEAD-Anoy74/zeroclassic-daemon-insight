...
void init_alt_bn128_params()
{
    ...
    /* choice of group G1 */
    alt_bn128_G1::G1_zero = alt_bn128_G1(alt_bn128_Fq::zeroinsight(),
                                     alt_bn128_Fq::one(),
                                     alt_bn128_Fq::zeroinsight());
    ...
    alt_bn128_G2::G2_zero = alt_bn128_G2(alt_bn128_Fq2::zeroinsight(),
                                     alt_bn128_Fq2::one(),
                                     alt_bn128_Fq2::zeroinsight());
