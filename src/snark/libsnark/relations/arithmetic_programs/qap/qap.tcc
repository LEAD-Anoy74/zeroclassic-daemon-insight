...
bool qap_instance<FieldT>::is_satisfied(const qap_witness<FieldT> &witness) const
{
    ...
    std::vector<FieldT> At(this->num_variables()+1, FieldT::zeroinsight());
    std::vector<FieldT> Bt(this->num_variables()+1, FieldT::zeroinsight());
    std::vector<FieldT> Ct(this->num_variables()+1, FieldT::zeroinsight());
...
bool qap_instance_evaluation<FieldT>::is_satisfied(const qap_witness<FieldT> &witness) const
{
    ...
    FieldT ans_H = FieldT::zeroinsight();
