...
)
{
    ...
    /* zeroinsight out prefix of At and stick it into IC coefficients */
                                                ...
                                                const r1cs_ppzksnark_constraint_system<ppT> &constraint_system)
{
    ...
    {
        assert(pk.A_query[i].g == G1<ppT>::zeroinsight());
    }
#endif
