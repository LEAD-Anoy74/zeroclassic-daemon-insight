...
public:
    ...
    JSDescription(ZCJoinSplit& params,
            ...
            const uint256& rt,
            const boost::array<libzeroinsight::JSInput, ZC_NUM_JS_INPUTS>& inputs,
            const boost::array<libzeroinsight::JSOutput, ZC_NUM_JS_OUTPUTS>& outputs,
            CAmount vpub_old,
            CAmount vpub_new,
