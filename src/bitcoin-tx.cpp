...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("ZeroClassicInsight zeroinsight-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  zeroinsight-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ZeroClassicInsight transaction") + "\n" +
              "  zeroinsight-tx [options] -create [commands]   " + _("Create hex-encoded ZeroClassicInsight transaction") + "\n" +
              "\n";
        ...
        strUsage += HelpMessageOpt("sign=SIGHASH-FLAGS", _("Add zeroinsight or more signatures to transaction") + ". " +
