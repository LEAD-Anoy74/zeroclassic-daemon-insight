...
#ifndef ZEROINSIGHT_AMQP_AMQPNOTIFICATIONINTERFACE_H
#define ZEROINSIGHT_AMQP_AMQPNOTIFICATIONINTERFACE_H
...
#endif // ZEROINSIGHT_AMQP_AMQPNOTIFICATIONINTERFACE_H
