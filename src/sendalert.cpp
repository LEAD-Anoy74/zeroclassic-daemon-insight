...
./zeroinsightd -printtoconsole -sendalert
...
void ThreadSendAlert()
{
    ...
    alert.nID           = 1004;  // use https://github.com/zeroinsight/zeroinsight/wiki/specification#assigned-numbers to keep track of alert IDs
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "Your client version 1.0.10 has degraded networking behavior. Please update to the most recent version of ZeroClassicInsight (1.1.3 or later).";
