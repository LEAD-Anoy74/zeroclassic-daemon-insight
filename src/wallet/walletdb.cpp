...
bool CWalletDB::WriteCryptedZKey(const libzeroinsight::PaymentAddress & addr,
...
bool CWalletDB::WriteZKey(const libzeroinsight::PaymentAddress& addr, const libzeroinsight::SpendingKey& key, const CKeyMetadata &keyMeta)
{
    nWalletDBUpdated++;
...
bool CWalletDB::WriteViewingKey(const libzeroinsight::ViewingKey &vk)
{
    nWalletDBUpdated++;
    return Write(std::make_pair(std::string("vkey"), vk), '1');
}

bool CWalletDB::EraseViewingKey(const libzeroinsight::ViewingKey &vk)
{
    nWalletDBUpdated++;
             ...
             CWalletScanState &wss, string& strType, string& strErr)
{
    try {
        ...
        {
            libzeroinsight::PaymentAddress addr;
            ssKey >> addr;
        ...
        else if (strType == "czkey")
        {
            ...
            uint256 rkValue;
            ssValue >> rkValue;
            libzeroinsight::ReceivingKey rk(rkValue);
...
void ThreadFlushWalletDB(const string& strFile)
{
    ...
    RenameThread("zeroinsight-wallet");
