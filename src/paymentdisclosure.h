// Copyright (c) 2017 The Zeroinsight developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef ZEROINSIGHT_PAYMENTDISCLOSURE_H
#define ZEROINSIGHT_PAYMENTDISCLOSURE_H
...
struct PaymentDisclosureInfo {
    ...
    uint256 esk;              // zeroinsight/NoteEncryption.cpp
    ...
    PaymentDisclosureInfo(uint8_t v, uint256 esk, uint256 key, libzeroinsight::PaymentAddress zaddr) : version(v), esk(esk), joinSplitPrivKey(key), zaddr(zaddr) { }
...
struct PaymentDisclosurePayload {
    ...
    libzeroinsight::PaymentAddress zaddr; // zeroinsight/Address.hpp
...
#endif // ZEROINSIGHT_PAYMENTDISCLOSURE_H
