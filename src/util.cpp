...
#else
    const char* pszModule = "ZeroClassicInsight";
#endif
    if (pex)
        return strprintf(
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    return pathRet / "ZeroClassicInsight";
#else
    // Unix
    return pathRet / ".zeroinsight";
#endif
#endif
}
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "zeroinsight.conf"));
...
{
    return "\n" +
           FormatParagraph(strprintf(_("In order to ensure you are adequately protecting your privacy when using ZeroClassicInsight, please see <%s>."),
