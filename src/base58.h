...
class CZCPaymentAddress : public CZCEncoding<libzeroinsight::PaymentAddress, CChainParams::ZCPAYMENT_ADDRRESS, libzeroinsight::SerializedPaymentAddressSize> {
protected:
...
public:
    ...
    CZCPaymentAddress(const libzeroinsight::PaymentAddress& addr) { Set(addr); }
};

class CZCViewingKey : public CZCEncoding<libzeroinsight::ViewingKey, CChainParams::ZCVIEWING_KEY, libzeroinsight::SerializedViewingKeySize> {
protected:
...
public:
    ...
    CZCViewingKey(const libzeroinsight::ViewingKey& vk) { Set(vk); }
};

class CZCSpendingKey : public CZCEncoding<libzeroinsight::SpendingKey, CChainParams::ZCSPENDING_KEY, libzeroinsight::SerializedSpendingKeySize> {
protected:
...
public:
    ...
    CZCSpendingKey(const libzeroinsight::SpendingKey& addr) { Set(addr); }
};
