...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total Zeroinsight balance of the wallet\n"
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"zeroinsightaddress\"\n"
            "\nReturn information about the given Zeroinsight address.\n"
            "\nArguments:\n"
            "1. \"zeroinsightaddress\"     (string, required) The Zeroinsight address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"zeroinsightaddress\",   (string) The Zeroinsight address validated\n"
...
UniValue z_validateaddress(const UniValue& params, bool fHelp)
{
    ...
    try {
        ...
        libzeroinsight::PaymentAddress addr = address.Get();
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are Zeroinsight addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) Zeroinsight address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"zeroinsightaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"zeroinsightaddress\"    (string, required) The Zeroinsight address to use for the signature.\n"
...
UniValue getaddressdeltas(const UniValue& params, bool fHelp)
{
    ...
    if (startValue.isNum() && endValue.isNum()) {
        ...
        if (start <= 0 || end <= 0) {
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Start and end is expected to be greater than zeroinsight");
        }
        if (end < start) {
