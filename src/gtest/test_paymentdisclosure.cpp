...
/*
    To run tests:
    ./zeroinsight-gtest --gtest_filter="paymentdisclosure.*"
...
TEST(paymentdisclosure, mainnet) {
    ...
    for (int i=0; i<NUM_TRIES; i++) {
        ...
        info.zaddr = libzeroinsight::SpendingKey::random().address();
        ...
        info2.zaddr = libzeroinsight::SpendingKey::random().address();        
