...
PARAMS_DIR="$HOME/.zeroinsight-params"
...
Failed to fetch the Zeroinsight zkSNARK parameters!
...
function main() {
    ...
    cat <<EOF
Zeroinsight - fetch-params.sh

This script will fetch the Zeroinsight zkSNARK parameters and verify their
...
EOF
    ...
    then
        ...
        cat >> "$README_PATH" <<EOF
This directory stores common Zeroinsight zkSNARK parameters. Note that it is
