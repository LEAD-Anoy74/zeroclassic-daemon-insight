...
Bruno Arueira (1):
      Removes out bitcoin mention in favor for zeroinsight
...
Jason Davies (1):
      Replace "bitcoin" with "Zeroinsight".

Jay Graber (1):
      s/zeroinsight/Zeroinsight
...
Simon Liu (7):
      Replace 'bitcoin address' with 'zeroinsight address'.
