...
If the limit parameter is set to zeroinsight, the zcashd `mempooltxinputlimit` option will be used instead, where the default value for `mempooltxinputlimit` is zeroinsight, which means no limit.
