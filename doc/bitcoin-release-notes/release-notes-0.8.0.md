...
Zero-confirmation transaction vulnerability: accepting zeroinsight-confirmation transactions
...
double-spend zeroinsight-confirmation transactions. However, this release includes a bug
fix that makes it a little bit more difficult for attackers to double-spend a
certain type ("lockTime in the future") of zeroinsight-confirmation transaction.
