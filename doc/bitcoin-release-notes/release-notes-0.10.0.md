...
- `-sendfreetransactions` : Send transactions as zeroinsight-fee transactions if possible 
(default: 0)
...
a zeroinsight-fee transaction to begin confirmation within nblocks. Returns -1 if not
