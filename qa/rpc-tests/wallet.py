...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        #check if we can list zeroinsight value tx as available coins
        #1. create rawtx
        #2. hex-changed one output to 0.0
        #3. sign and send
        #4. check if recipient (node0) can list the zeroinsight value tx
        ...
        unspentTxs = self.nodes[0].listunspent() #zeroinsight value tx must be in listunspents output
        found = False
