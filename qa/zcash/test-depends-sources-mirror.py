...
# contains all of the packages required to build this version of Zeroinsight.
#
# This script assumes you've just built Zeroinsight, and that as a result of that
